...
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (2, 2, '5053459221', TO_DATE('2020/08/09', 'yyyy/mm/dd'), 34, 48);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (2, 2, '2991300528', TO_DATE('2020/08/12', 'yyyy/mm/dd'), 10, 45);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (9, 1, '3749127802' ,TO_DATE('2020/01/12', 'yyyy/mm/dd'), 2, 26);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (1, 1, '9677906902', TO_DATE('2019/02/09', 'yyyy/mm/dd'), 8, 20);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (1, 2, '2092327757', TO_DATE('2020/03/09', 'yyyy/mm/dd'), 35, 20);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (1, 2, '5838732484', TO_DATE('2018/04/09', 'yyyy/mm/dd'), 56, 28);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (2, 2, '3245779779', TO_DATE('2020/05/09', 'yyyy/mm/dd'), 49, 6);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (10, 2,'6555390862' , TO_DATE('2019/06/09', 'yyyy/mm/dd'), 53, 40);
insert into REGISTRANCARNET (idlector, tipocarnet, idvisitante, fecha, horaentrada, horasalida) values (2, 1, '3757003542', TO_DATE('2020/07/08', 'yyyy/mm/dd'), 5, 18);
