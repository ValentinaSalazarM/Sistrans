...
//			System.out.println (msg);
    ...
    public void baseDatosInaccesible ()
    {
		try
		{
			...
			aforoAndes = new AforoAndes (openConfig (CONFIG_TABLAS_ERR_DS));
...
//			e.printStackTrace();
    ...
    public void usuarioInvalidoTest ()
    {
		try
		{
			...
			aforoAndes = new AforoAndes (openConfig (CONFIG_TABLAS_ERR_USER));
...
//			e.printStackTrace();
    ...
    public void tablaInexistenteTest ()
    {
		...
		try
		{
			...
			aforoAndes = new AforoAndes (openConfig (CONFIG_TABLAS_B));
		}
		catch (Exception e)
		{
//			e.printStackTrace();
