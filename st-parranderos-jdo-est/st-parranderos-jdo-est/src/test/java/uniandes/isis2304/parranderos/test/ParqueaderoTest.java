...
public class ParqueaderoTest 
{
	...
	/* ****************************************************************
	 * 			Métodos de prueba para la tabla Parqueadero - Creación 
	 *****************************************************************/
	...
	public void primeraVez() 
	{
		...
		try
		{
			...
			assertEquals ("No deben haber parqueaderos creados!!", 0, lista.size ());
			...
			String identificador = "PAR099";
			VOParqueadero parqueadero1 = aforoAndes.adicionarParqueadero(identificador, cn.getId(), area1.getId() ,cc.getIdentificador());
			lista = aforoAndes.darVOParqueaderos();
			assertEquals ("Debe haber un parqueadero creado !!", 1, lista.size ());
	 ...
	 */
	@Test
	public void unicidadIDParqueaderoTest() 
	{
		// Probar primero la conexión a la base de datos
		try
		{
		...
		try
		{
			...
			VOParqueadero pq2 = aforoAndes.adicionarParqueadero(identificador, cn.getId(), area1.getId(), cc.getIdentificador());
			assertNull ("No puede adicionar dos parqueaderos con el mismo id !!", pq2);
		}
		catch (Exception e)
		{
			//			e.printStackTrace();
