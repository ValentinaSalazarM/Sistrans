...
public class DialogoAdicionarTipoVisitante extends JDialog implements ActionListener
{
	...
	public void actionPerformed( ActionEvent pEvento )
	{
		...
		if( comando.equals( AGREGAR ) )
		{
			...
			if( tipo.equals( "" ) || horarioInicio.equals( "" ) || horarioInicio.equals( "" ))
			{
			...
			{    
				...
				{
					JOptionPane.showMessageDialog( this, "Las horas deben ser números separados por :", "Agregar Visitante", JOptionPane.ERROR_MESSAGE );
				}
			}
		}
