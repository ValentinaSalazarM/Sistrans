...

{
	 ...
	 */
	public long adicionarVisitanCC (PersistenceManager pm, long idCC, long idvisitante) 
	{
	 ...
	 */
	public long eliminarVisitanLocal (PersistenceManager pm, long idCC, long idVisitante) 
	{
