...
public class DialogoConsultarIndiceAforoCC extends JDialog implements ActionListener
{
	 ...
	 */
	public final static String ACEPTAR = "Consultar índice de aforo de un centro comercial";
	...
	/**
	 * Etiqueta del identificador del centro comercial
	 */
	private JLabel lblCentroComercial;

	/**
	 * Campo de texto para el identificador del centro comercial
	 */
	 ...
	 */
	public DialogoConsultarIndiceAforoCC( InterfazAforoAndesApp pPrincipal )
	{
		interfaz = pPrincipal;
	...
	public void actionPerformed( ActionEvent pEvento )
	{
		...
		{
			String idCentroComercial = txtCentroComercial.getText();
			...
			else
			{
				try
				{
					...
					else
					{
						...
						interfaz.consultarIndicesAforoCentroComercial(idCentroComercial, fechaInicialTS, fechaFinalTS, horaInicial, minutoInicial, horaFinal, minutoFinal, this);
					}
				}
